...
create = function (req, res) {
    ...
    var response = {}
    var query = "INSERT INTO users (name, contact, email, sex, password, econtact, age) VALUES('" + 
                req.body.name + "', '" + req.body.contact + "', '" + req.body.email + "', " + req.body.sex + 
                ", '" + req.body.password + "', '" + req.body.econtact + "', "+ req.body.age;
