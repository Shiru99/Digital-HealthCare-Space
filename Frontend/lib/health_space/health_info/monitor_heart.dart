...
class MonitorViewHeart extends StatefulWidget {
  final AnimationController? animationController;
  final Animation<double>? animation;

  const MonitorViewHeart({Key? key, this.animationController, this.animation})
      : super(key: key);

  @override
  State<MonitorViewHeart> createState() => _MonitorViewHeartState();
}

class _MonitorViewHeartState extends State<MonitorViewHeart> {
  var riskPercentage = 50;
  var pulseRate = 60;
  var bloodPressure = 80;

  var bodyTemp = 37;
  var bloodOxygen = 90;
  var bloodCholesterol = 120;

  var lowBloodPressure = 80;

  var bloodGlucose = 90;

  var bloodFat = 90;

  var bloodSugarFasting = 90;
  var bloodSugarPostPrandial = 90;
                                ...
                                Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(top: 6),
                                      child: Text(
                                        bloodCholesterol.toString() + ' mg/dL',
                                        textAlign: TextAlign.center,
                                        style: TextStyle(
                                          fontFamily: FitnessAppTheme.fontName,
                                          fontWeight: FontWeight.w600,
